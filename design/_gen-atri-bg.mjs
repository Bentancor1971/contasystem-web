/**
 * Genera el banner de cumpleaños para ATRI.
 * Salida:
 *   <repo>/design/atri-cumpleanos-fondo.svg
 *   <repo>/design/atri-cumpleanos-fondo.png   (1200x500, para subir)
 *
 * Proporción banner: el mail apila imagen arriba + tarjeta con el saludo
 * abajo, así que el wordmark queda centrado en la imagen.
 *
